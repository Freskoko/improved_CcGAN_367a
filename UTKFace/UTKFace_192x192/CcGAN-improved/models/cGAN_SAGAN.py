...
class cGAN_SAGAN_Generator(nn.Module):
    ...
    def __init__(self, z_dim, num_classes, g_conv_dim=64):
        ...
        self.snlinear0 = snlinear(in_features=z_dim, out_features=g_conv_dim*16*6*6)
    ...
    def forward(self, z, labels):
        # n x z_dim
        act0 = self.snlinear0(z)            # n x g_conv_dim*16*6*6
        act0 = act0.view(-1, self.g_conv_dim*16, 6, 6) # n x g_conv_dim*16 x 6 x 6
        act1 = self.block1(act0, labels)    # n x g_conv_dim*16 x 12 x 12
        act2 = self.block2(act1, labels)    # n x g_conv_dim*8 x 24 x 24
        act3 = self.block3(act2, labels)    # n x g_conv_dim*4 x 48 x 48
        act3 = self.self_attn(act3)         # n x g_conv_dim*4 x 48 x 48
        act4 = self.block4(act3, labels)    # n x g_conv_dim*2 x 96 x 96
        act5 = self.block5(act4, labels)    # n x g_conv_dim  x 192 x 192
...
class cGAN_SAGAN_Discriminator(nn.Module):
    ...
    def forward(self, x, labels):
        ...
        h5 = self.relu(h5)              # n x d_conv_dim*16 x 6 x 6
