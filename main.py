...
# --- SETTINGS ---
CSV_PATH = "./datasets/grass/train.csv"
IMG_DIR = "./datasets/grass/train"
OUTPUT_H5 = "./datasets/grass/Cell200_64x64.h5"
IMG_SIZE = 64
...
for _, row in tqdm(df_wide.iterrows(), total=len(df_wide)):
    img_full_path = os.path.join(IMG_DIR, row['image_path'])
